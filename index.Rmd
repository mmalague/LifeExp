...
I this study, I plan to examine the correlation between health insurance coverage and life expectancy, across counties in the New England states. I hypothesize that communities with less health insurance coverage will have lower average life expectancies. 
...
PERFECT |>
  ggplot(aes(x = `Percent of Population with No Health Insurance Coverage`, y = mean_LE, color = STATEFP,
                     fill = STATEFP)) +
   geom_smooth(method = "lm", se = FALSE) + geom_hline(aes(yintercept = mean(mean_LE)), color = "black", linetype = 3) + 
  geom_vline(aes(xintercept = mean(`Percent of Population with No Health Insurance Coverage`)), color = "black", linetype = 3) + 
  labs(x = "Percent of Population with No Health Insurance Coverage",
       y = "Mean Life Expectancy",
       title = "Percent of Population without Health Insurance -- and Average Life Expectancy",
