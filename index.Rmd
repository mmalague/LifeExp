...
In this study, I examine the correlation between health insurance coverage and life expectancy, across counties in the New England states of Maine, Massachusetts, New Hampshire, Rhode Island, and Vermont. I hypothesize that communities with less health insurance coverage will have lower average life expectancies. 
...
The following visualization includes a point for each county, colored according to its state. 
